...
export default {
    ...
    async scheduleLocalNotificationAsync(notification, options = {}) {
        ...
        if (options.time) {
            ...
            warning(timeAsDateObj.getTime() >= now, `Provided value for "time" is before the current date. Did you possibly pass number of seconds since Unix Epoch instead of number of milliseconds?`);
