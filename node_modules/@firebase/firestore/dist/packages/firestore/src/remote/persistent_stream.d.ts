...
export declare abstract class PersistentStream<SendType, ReceiveType, ListenerType extends PersistentStreamListener> {
    ...
    private state;
    private inactivityTimerPromise;
    private stream;
    protected backoff: ExponentialBackoff;
    protected listener: ListenerType | null;
    constructor(queue: AsyncQueue, connectionTimerId: TimerId, idleTimerId: TimerId, connection: Connection, credentialsProvider: CredentialsProvider);
    /**
